...
var gcCalBG = "#731514"; // the background color of the outer calendar panel.
var guCalBG = "#731514"; //  the background image url for the inner table.
var gcCalFrame = "#731514"; // the background color of the inner table, showing as a frame.
...
var gsBottom =
  "<A href='javascript:void(0)' class='BottomAnchor' style='color:red;' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"You cannot select today!\");return false;' onmouseover='return true;' >Today : " +
  gMonths[gToday[1] - 1] +
  " " +
  gToday[2] +
  ", " +
  gToday[0] +
  "</A>"; // the content of the bottom section.
...
var gcCellBG = "#731514"; // default background color of the cells. Use "" for transparent!!!
