    ...
    m = function (a, b) {
      ...
      if (this instanceof m) {
        ...
        this.dom = {
          ...
          body: null,
          footer: null,
          grid: { wrapper: null, dt: null, left: { wrapper: null, head: null, body: null, foot: null }, right: { wrapper: null, head: null, body: null, foot: null } },
  ...
  d.extend(m.prototype, {
    ...
    _fnGridLayout: function () {
      ...
      0 < this.s.iLeftColumns &&
        ...
        (e.style.width = g + "px"),
        (e.style.height = "1px"),
        i ? ((e.style.left = ""), (e.style.right = 0)) : ((e.style.left = 0), (e.style.right = "")),
      ...
      0 < this.s.iRightColumns &&
        ...
        (e.style.width = h + "px"),
        (e.style.height = "1px"),
        this.s.rtl ? ((e.style.left = f.y ? f.bar + "px" : 0), (e.style.right = "")) : ((e.style.left = ""), (e.style.right = f.y ? f.bar + "px" : 0)),
      ...
      for (var e = [], f = [], g = [], h = 0, i = a.length; h < i; h++) {
        ...
        for (var l = 0, o = this.s.iTableColumns; l < o; l++)
          if (-1 !== d.inArray(l, b)) {
            ...
            -1 === p ? ((p = d(a[h][l].cell).clone(c, !1)[0]), f.push(p), g.push(a[h][l].cell), j.push({ cell: p, unique: a[h][l].unique })) : j.push({ cell: f[p], unique: a[h][l].unique });
          }
        e.push(j);
      }
      return e;
