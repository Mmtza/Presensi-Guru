        ...
        p = function (c, e) {
          ...
          for (h = e.length; k < h; k++)
            if (((a = e[k]), b.isArray(a))) p(c, a);
              ...
              d &&
                ((o = b("<li>", { class: u.sPageButton + " " + f, id: 0 === r && "string" === typeof a ? g.sTableId + "_" + a : null })
                  .append(b("<a>", { href: "#", "aria-controls": g.sTableId, "data-dt-idx": n, tabindex: g.iTabIndex }).html(d))
                  .appendTo(c)),
